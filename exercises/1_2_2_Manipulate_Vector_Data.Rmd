...
Calculate the number of Covid-19 cases in the last 7 days (cases_7days) by population (population) and multiply with 100,000 (in Germany usually called "7 Tages Inzidenzzahl). Call the column "covid7d_rate".

Select Cologne (district_id==5315), find the surrounding districts and plot only the Covid Rate in Cologne and the surrounding districts.

```

```{block, opts.label = "clues"}

You can use the dplyr function `bind_rows` to cobine the information of cologne and the surrounding districts.
...
st_write(cologne_sur, 
         dsn = "./data/own_exports/cologne_covid19_eps3035", 
