...
Let us go back where we stopped developing our mapping techniques yesterday: Our Corona Map.
This is just a super short repetition of what was just presented.
No worries, we're going to have some time to improve your maps.
...
The hospital shapefile contains information on the number of beds in each hospital.
Can you change the size of hospital dots according to the number of beds?
