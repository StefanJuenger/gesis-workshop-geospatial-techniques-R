...
You might already spot that we have an id for the districts (*id* and *district_ic*) in both data tables. 
...
st_write(german_districts_enhanced, 
         dsn = "./data/own_material/districts_enhanced_epsg3035.shp", 
...
write.csv(german_districts_enhanced , 
          "./data/own_material/german_districts_enhanced.csv", 
          row.names = F, na= "." )
  
# Export data frame as csv with geometric attributes
st_write(hospitals_sf, "./data/own_material/hospitals_epsg3035.csv", 
...
You can load, transform, manipulate and export vector data. `emo::ji("confetti")`

The next step is producing an awesome map, and you are already well-equipped!
]
